        ...
        [ new Floor("First Floor", "First Floor Description", [
            new Chapter("First Chapter", ["First chapter description 1.", "First chapter description 2.", "First chapter description 3."], 
                new Baddie("Baddie 1", 
                    [createRadicalPog(1)], 
                        100, 3)),
            new Chapter("Shop Chapter", [" description 1.", "description 2.", "description 3."], 
                new Shop("Shop 1", "This is a demo shop.", 
                    [new Item("Participation Trophy", "1 Participation Award", 55)], 
                    [createActionPogByInput({name: "Crunch", gold: 0, action: 'double_attack', description: 'Doubles the next attack.'}),
                        createActionPogByInput({name: "Nom", gold: 15, action: 'pizza_5', description: 'Adds 5 health.'}),
                        createActionPogByInput({name: "Nom", gold: 30, action: 'pizza_10', description: 'Adds 10 health.'}),
                        createActionPogByInput({name: "Crunch", gold: 0, action: 'double_attack', description: 'Doubles the next attack.'}),
                        createActionPogByInput({name: "Crunch", gold: 0, action: 'double_attack', description: 'Doubles the next attack.'}),
                        createActionPogByInput({name: "Hide", gold: 0, action: 'double_defense', description: 'Doubles your current defense.'}),
                        createActionPogByInput({name: "Hide", gold: 0, action: 'double_defense', description: 'Doubles your current defense.'}),
                        createLuckyPog(1),
                        createRadicalPog(1),
                        createRadicalPog(1),
                    ...
                    [createRadicalPog(1)], 
                        ...
                        new Chapter("Second Chapter", ["Second chapter description 1.", "Second chapter description 2.", "Second chapter description 3."], 
                            new Shop("Shop 1", "This is a demo shop.", 
                                [new Item("Participation Trophy", "1 Participation Award", 55)], 
                                [createButtPog(11),
                                    new CombatPog("Big Honker", 10, 10, 100),
                                    new CombatPog("Pog Mania", 15, 10, 200),
                                    new CombatPog("Biiig Defense", 2, 10, 35),
                                ], 
