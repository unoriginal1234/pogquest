...
function createDemoStory() {
    return new Story(
        ...
        [ new Floor("Lobby", "You burst through the spinning doors, and into the lobby...", [
            new Chapter("The Security Ogre lvl 1", ["The ogre looks up from his newspaper..", "You grip your fist full of pogs. Ready for anything.", "The Security Desk burns with blue flames." ], 
                new Baddie("Security Ogre", 
                    [createPogByInput({name: "Guard Smash", strength: 3, defense: 2}), 
                        ...
                        20, 1)),
            new Chapter("Information Demon lvl 1", ["The Demon shouts into a phone: \"No the flowers are supposed to be black!\"", "Time to mix pogs with the Demon.", "The only information we have are our pogs."], 
            ...
            new Chapter("Scrug lvl 2", ["\"You're not authoriiiiized!\"", "Scrug's got a big stack of pogs.", "Time to smash Pogs with Scrug."], 
                new Baddie("Scrug, the Devil's lil Guy", 
                    [createPogByInput({name: "Whiiine", strength: 5, defense: 0}),
                        createDefensePog(3),
                        createDefensePog(4),
                        createAttackPog(4), 
                        createDefensePog(2),
            ...
            new Chapter("Empty Board Room", ["A Wizard's casting chill spells.", "\"Come sit by the fire.\"", "You sit by the fire."], 
                new Adventure("Wizard's Fire", "\"We should hang out some time.\"", "campfire")),
            new Chapter("Scum Gooner lvl 3", ["A little demon in the gooning to scum", "Ew, he just pooped a little bit.", "The hallway reeks."], 
                new Baddie("Scum Gooner", 
                    [createPogByInput({name: "Scum Goo", strength: 4, defense: 4}), 
                        createDefensePog(4), 
                        createAttackPog(3),
                        createAttackPog(3),
                        createDefensePog(2),
        ...
        new Floor("Deep Below the Lobby", "A pulse fills your ears as you exit the elevator.", [
            new Chapter("Criminee Bajins lvl 4", ["\"Let's see how our pogs stack up?\"", "You turn and run, but he's on you..", "Gotta pog the pog."], 
                ...
                new Chapter("Randal Damnit lvl 4", ["\"Hot diggity dog! I'm Randall Damnit!\"", "A sharp toothed sneer greets you.", "The room stinks of copper."], 
                    new Baddie("Randal Damnit", 
                        [createAttackPog(1), 
                            createDefensePog(2),
                            createAttackPog(3),
                            createDefensePog(5),
            ...
            new Chapter("Empty Board Room", ["A Wizard's casting chill spells.", "\"Come sit by the fire.\"", "You sit by the fire."], 
                new Adventure("Wizard's Fire", "\"We should hang out some time.\"", "campfire")),
            new Chapter("Beltway Fuzzlebottom lvl 5", ["\"Whip 'em out!\"", "Something's off about this one.", "The lights flicker."], 
                new Baddie("Criminee Bajins", 
                    [createAttackPog(3), 
                        createDefensePog(2),
            ...
            new SuperBaddie("Devil CEO", [
                ...
                createAttackPog(7),
                createDefensePog(8),
                createAttackPog(9),], 100, 8, "Final Super Power"))),
