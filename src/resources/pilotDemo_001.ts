...
function createDemoStory() {
    return new Story(
        ...
        [ new Floor("Lobby", "You burst through the spinning doors, and into the lobby...", [
            new Chapter("The Security Ogre lvl 1", ["The ogre looks up from his newspaper..", "\"Hey, who are you?\"", "You grip your fist full of pogs. Ready for anything."], 
                new Baddie("Security Ogre", 
                    [createButtPog(1), 
                        createButtPog(2), 
                        createPogByInput({name: "Loong Jacket", strength: 1, defense: 4})], 
                        20, 1)),
            new Chapter("Information Demon lvl 1", ["The Demon shouts into a phone.", "\"No, the roses are supposed to be black!\".", "Time to mix pogs with the Demon."], 
            ...
            new Chapter("Skeleton Accountant lvl 3", ["Have you filed?", "He runs pens on his ribs.", "Time to file some pogs."], 
            ...
            new Chapter("Empty Board Room", ["A Wizard's casting chill spells.", "\"Come sit by the fire.\"", "You sit by the fire."], 
                new Adventure("Wizard's Fire", "\"We should hang out some time.\"", "campfire")),
            new Chapter("Scum Fucker lvl 3", ["A little demon in the corner fucking scum", "Ew, he just pooped a little bit.", "The hallway reeks."], 
                new Baddie("Skeleton Accountant", 
                    [createButtPog(1), 
                        createButtPog(2), 
                        createButtPog(3),
