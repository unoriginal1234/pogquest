...
const demoStoryProps = {
    title: "Demo Story",
    description: "This is a demo story.",
    chapters: [new Chapter("The beginning", ["This is a old chapter 1.", "This is a demo chapter 2.", "This is a demo chapter 3."], new Baddie("Baddie 1", [new Pog("Pog 1", 1, 1, 1, 1)], 100, 1))],
    floors: [ new Floor("First Floor", "Floor Description", [
