            ...
            new Chapter("Just kidding the REAL end", ["This is a demo description 37.", "This is a demo description 38.", "This is a demo description 39."], 
                new Baddie("Baddie 5", 
                    [new Pog("Butt Pog 1", 1, 1, 1, 1), 
                        ...
                        new Pog("Butt Pog 6", 2, 2, 1, 1),
                        new Pog("Butt Pog 7", 1, 1, 1, 1),
                        new Pog("Butt Pog 8", 2, 3, 1, 1),
                        new Pog("Butt Pog 9", 2, 7, 1, 1),
                        new Pog("Butt Pog 10", 1, 10, 1, 1),
                        new Pog("Butt Pog 11", 5, 1, 1, 1),
                        new Pog("Butt Pog 6", 1, 12, 1, 1),
                        new Pog("Butt Pog 7", 12, 1, 1, 1),
                        new Pog("Butt Pog 8", 1, 1, 1, 1),
                        new Pog("Butt Pog 9", 7, 1, 1, 1),
                        new Pog("Butt Pog 10", 1, 6, 1, 1),
                        new Pog("Butt Pog 11", 10, 1, 1, 1),
                        new Pog("Butt Pog 7", 3, 1, 1, 1),
                        new Pog("Butt Pog 8", 4, 1, 1, 1),
                        new Pog("Butt Pog 9", 5, 1, 1, 1),
                        new Pog("Butt Pog 10", 1, 24, 1, 1),
                        new Pog("Butt Pog 11", 1, 34, 1, 1),
                        new Pog("Butt Pog 6", 7, 1, 1, 1),
                        new Pog("Butt Pog 7", 1, 4, 1, 1),
                        new Pog("Butt Pog 8", 2, 1, 1, 1),
                        new Pog("Butt Pog 9", 1, 3, 1, 1),
                        new Pog("Butt Pog 10", 3, 1, 1, 1),
                        new Pog("Butt Pog 11", 1, 2, 1, 1),
