...
function createDemoStory() {
    return new Story(
        ...
        [ new Floor("First Floor", "First Floor Description", [
            new Chapter("The beginning", ["This is a demo description 1.", "This is a demo description 2.", "This is a demo description 3."], new Baddie("Baddie 1", [new Pog("Butt Pog 1", 1, 1, 1, 1), new Pog("Butt Pog 2", 1, 1, 1, 1), new Pog("Butt Pog 3", 1, 1, 1, 1)], 100, 1)),
